        ...
        <div className="hero min-h-screen text-white">
            <div className=" hero-content flex flex-col lg:flex-row-reverse sm:32 md:36 lg:mx-40" data-aos="zoom-in-left" data-aos-duration="1000" data-aos-easing="ease-in-sine">
                ...
                <div className='min-w-lg'>
                    ...
                    <p className='text-xl tracking-wide leading-8 font-light mt-5 flex'><span className='text-[#ff3d00]'>Download My Resume</span> <a href="http://" target="_blank" rel="noopener noreferrer"><FaDownload className='w-8 h-8 ml-5 hover:text-[#ff3d00] hover:translate-y-1' /></a></p>
