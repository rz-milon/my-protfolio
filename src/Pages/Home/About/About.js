...
const About = () => {
    ...
    return (
        <div className="hero min-h-screen text-white">
            <div className=" hero-content flex flex-col lg:flex-row-reverse sm:32 md:36 lg:mx-48" data-aos="zoom-in-left" data-aos-duration="1000" data-aos-easing="ease-in-sine">
